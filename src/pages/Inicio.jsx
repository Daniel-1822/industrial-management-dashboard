import InventarioProducto from '../components/InventarioProducto';

const Inicio = () => {
  return (
    <main className="min-h-screen bg-white flex flex-col w-full">
      {/* Top Banner - Header al estilo del juego */}
      ...
      <div className="w-full h-32 bg-[#FFC500] relative overflow-hidden flex flex-col justify-between px-12 pt-6 pb-0 shadow-lg select-none">
        ...
        <div className="relative z-10 flex justify-between items-start">
          <div>
            ...
            <div className="flex gap-4 mt-2">
              <span className="text-[10px] font-bold text-industrial-dark/60 uppercase tracking-[0.2em]">Sector: 07-A</span>
          ...
          <div className="flex flex-col items-end gap-1 opacity-40">
            <div className="w-24 h-1 bg-industrial-dark/20 rounded-full overflow-hidden">
              <div className="w-2/3 h-full bg-industrial-dark animate-[shimmer_2s_infinite]" />
            </div>
            <span className="text-[8px] font-mono text-industrial-dark">EST: 98.4% CAP</span>
          </div>
        </div>
        ...
        <div className="relative z-20 flex">
          <div className="bg-[#fafafa] px-10 py-3 flex items-center gap-4 border-x border-t border-gray-200 translate-y-[1px] group cursor-default">
            ...
            <span className="text-black text-[11px] font-black uppercase tracking-[0.3em]">Componentes básicos</span>
          </div>
        </div>
      </div>
